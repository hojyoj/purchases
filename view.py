...
class Master(view.Master):
    ...
    def import__(self):
        ...
        self.app.stdoutLog.info("    purchases view Master.import__()")
        
        if self.imported:

            document = self.imported.pop(0)
            
            self.app.stdoutLog.error("    purchases view Master.import__()\n        document.data: {}\n".format(document.data))
            ...
            try:
                ...
                self.app.stdoutLog.error("!!! purchases.Master.import__()\n        Error: Could not process inexistent supplier\n")
                raise
        ...
        self.app.stdoutLog.info("    purchases view Master.import__() - END")
    ...
    def manager_update(self):
        # oldLevel = self.app.stdoutLog.level
        # self.app.stdoutLog.setLevel(logging.INFO)
        self.app.stdoutLog.info("    purchases.view  Master.manager_update()")

        view.Master.manager_update(self)
        self.import__()

        self.app.stdoutLog.info("    purchases.view  Master.manager_update() - END")
        # self.app.stdoutLog.setLevel(oldLevel)
...
class Manager(view.Manager):
    ...
    def data_update(self, *args):
        ...
        if not self.isVisible():
            self.app.stdoutLog.info("    purchases.view      Manager.data_update()    skipped")
        else:
            self.app.stdoutLog.info("    purchases.view      Manager.data_update()    passed")
...
class CaptureView(view.CaptureView):
    ...
    def __init__(self, *args, **kwds):        
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.__init__()")
...
#        self.mensajes2 = u""
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.__init__() - END")
    ...
    def modified_data(self):
        ...
        self.app.stdoutLog.info("    purchases view      CaptureView.modified_data()")
        ...
        self.app.stdoutLog.info("    purchases view      CaptureView.modified_data() - END")
    ...
    def set_data(self, document):
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.set_data()")
        ...
        try:
            ...
            self.app.stdoutLog.error("    purchases view  CaptureView.set_data()\n        document.kind:{}".format(document.kind))
        ...
        try:
            ...
            self.app.stdoutLog.error("    Could not set document items\n        document.items: {}".format(document.items))
        ...
        if eMessage:
            self.app.stdoutLog.error(eMessage)
            raise Fault("    purchases.CaptureView.set_data()", eMessage)

        self.app.stdoutLog.info("    purchases view  CaptureView.set_data() - END")
    ...
    def documentKind_update(self):
        self.app.stdoutLog.info("    purchases view  CaptureView.documentKind_update()")
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.documentKind_update() -END")
    ...
    def init(self, *args, **kwds):
        self.app.stdoutLog.info("    purchases view  CaptureView.init()")
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.init() - END")
    ...
    def orders_reset(self, rol_id=None):
        ...
        # oldLevel = self.app.stdoutLog.level
        # self.app.stdoutLog.setLevel(logging.INFO)
        self.app.stdoutLog.info("    purchase view  CaptureView.orders_reset()")
        ...
        self.app.stdoutLog.info("    purchase view  CaptureView.orders_reset() - END")
        # self.app.stdoutLog.setLevel(oldLevel)
    ...
    def productAdded(self, product):
        ...
        if self.waitsForProduct:
            try:
                ...
                self.app.stdoutLog.error("        purchases.CaptureView.productAdded()\n            origin: {}\n            product: {}".format(self.ui.itemsTA.origin(), product))
                raise
            else:
    ...
    def save(self):
        ...
        oldLevel = self.app.stdoutLog.level
        self.app.stdoutLog.setLevel(logging.INFO)
        self.app.stdoutLog.info("    purchases view  CaptureView.save()")
        ...
        self.app.stdoutLog.info("    purchases view  CaptureView.save() - END")
        self.app.stdoutLog.setLevel(oldLevel)
...
class Details(view.Details):
    ...
    def setData(self, document):
        self.app.stdoutLog.info("    purchases view          Details.setData()")
...
#        payment = app.model.getDocumento(proceso_id=compra['proceso_id'], operacion_tipo='pago')
        ...
        self.app.stdoutLog.info("    purchases view          Details.setData() - END")
